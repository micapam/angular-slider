            ...
            compile: function(element, attributes) {
                ...
                return {
                    post: function(scope, element, attributes) {
                        var bar, barWidth, bound, ceilBub, changeFn, dimensions, e, flrBub, handleHalfWidth, highBub, lowBub, maxOffset, maxPtr, maxValue, minOffset, minPtr, minValue, ngDocument, offsetRange, selection, transformFn, updateDOM, upper, valueRange, w, _i, _j, _len, _len1, _ref, _ref1;
                        _ref = (function() {
                        ...
                        scope.bubbleValue = function() {
                            ...
                            return transformFn(value, scope.floor, scope.ceiling);
                        };
                        dimensions = function() {
                            var value, _j, _len1, _ref2, _ref3, _ref4, _ref5, _ref6;
                            if ((_ref2 = scope.step) == null) {
                                scope.step = 1;
                            }
                            if ((_ref3 = scope.floor) == null) {
                                scope.floor = 0;
                            }
                            ...
                            if ((_ref5 = scope.values) != null ? _ref5.length : void 0) {
                                if ((_ref6 = scope.ceiling) == null) {
